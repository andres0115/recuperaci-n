...
const Dashboard: React.FC<DashboardProps> = ({ userName = "Administrador", children }) => {
    ...
    <div className="flex h-screen bg-gray-50 text-gray-800 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
          {children ? (
            // Si hay children, renderizar el contenido personalizado
            children
          ) : (
            // Si no hay children, renderizar el dashboard por defecto
            <>
              <div className="mb-6">
